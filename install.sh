...
install() {
  ...
  [[ -d ${SCHEMES_DIR}/WinConceptOS.colors ]] && rm -r ${SCHEMES_DIR}/WinConceptOS.colors
  ...
  [[ ${color} == '' ]] && \
  cp -ur ${SRC_DIR}/color-schemes/WinConceptOS.colors                                    ${SCHEMES_DIR} && \
  cp -ur ${SRC_DIR}/color-schemes/WinConceptOS.colors                                    ${PLASMA_DIR}/${name}/colors

  [[ ${color} == '-light' ]] && \
  cp -ur ${SRC_DIR}/color-schemes/WinConceptOS.colors                               ${SCHEMES_DIR}
}

echo "Installing 'WinConceptOS kde themes'..."
